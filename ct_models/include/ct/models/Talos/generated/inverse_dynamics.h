#ifndef IIT_TALOS_INVERSE_DYNAMICS_H_
#define IIT_TALOS_INVERSE_DYNAMICS_H_
...
/**
 * The Inverse Dynamics routine for the robot Talos.
 *
...
public:
    ...
    typedef iit::Talos::tpl::JointState<Scalar> JointState;
...
public:
    ...
    const Velocity& getVelocity_leg_left_1_link() const { return leg_left_1_link_v; }
    const Acceleration& getAcceleration_leg_left_1_link() const { return leg_left_1_link_a; }
    const Force& getForce_leg_left_1_link() const { return leg_left_1_link_f; }
    const Velocity& getVelocity_leg_left_2_link() const { return leg_left_2_link_v; }
    const Acceleration& getAcceleration_leg_left_2_link() const { return leg_left_2_link_a; }
    const Force& getForce_leg_left_2_link() const { return leg_left_2_link_f; }
    const Velocity& getVelocity_leg_left_3_link() const { return leg_left_3_link_v; }
    const Acceleration& getAcceleration_leg_left_3_link() const { return leg_left_3_link_a; }
    const Force& getForce_leg_left_3_link() const { return leg_left_3_link_f; }
    const Velocity& getVelocity_leg_left_4_link() const { return leg_left_4_link_v; }
    const Acceleration& getAcceleration_leg_left_4_link() const { return leg_left_4_link_a; }
    const Force& getForce_leg_left_4_link() const { return leg_left_4_link_f; }
    const Velocity& getVelocity_leg_left_5_link() const { return leg_left_5_link_v; }
    const Acceleration& getAcceleration_leg_left_5_link() const { return leg_left_5_link_a; }
    const Force& getForce_leg_left_5_link() const { return leg_left_5_link_f; }
    const Velocity& getVelocity_leg_left_6_link() const { return leg_left_6_link_v; }
    const Acceleration& getAcceleration_leg_left_6_link() const { return leg_left_6_link_a; }
    const Force& getForce_leg_left_6_link() const { return leg_left_6_link_f; }
    const Velocity& getVelocity_leg_right_1_link() const { return leg_right_1_link_v; }
    const Acceleration& getAcceleration_leg_right_1_link() const { return leg_right_1_link_a; }
    const Force& getForce_leg_right_1_link() const { return leg_right_1_link_f; }
    const Velocity& getVelocity_leg_right_2_link() const { return leg_right_2_link_v; }
    const Acceleration& getAcceleration_leg_right_2_link() const { return leg_right_2_link_a; }
    const Force& getForce_leg_right_2_link() const { return leg_right_2_link_f; }
    const Velocity& getVelocity_leg_right_3_link() const { return leg_right_3_link_v; }
    const Acceleration& getAcceleration_leg_right_3_link() const { return leg_right_3_link_a; }
    const Force& getForce_leg_right_3_link() const { return leg_right_3_link_f; }
    const Velocity& getVelocity_leg_right_4_link() const { return leg_right_4_link_v; }
    const Acceleration& getAcceleration_leg_right_4_link() const { return leg_right_4_link_a; }
    const Force& getForce_leg_right_4_link() const { return leg_right_4_link_f; }
    const Velocity& getVelocity_leg_right_5_link() const { return leg_right_5_link_v; }
    const Acceleration& getAcceleration_leg_right_5_link() const { return leg_right_5_link_a; }
    const Force& getForce_leg_right_5_link() const { return leg_right_5_link_f; }
    const Velocity& getVelocity_leg_right_6_link() const { return leg_right_6_link_v; }
    const Acceleration& getAcceleration_leg_right_6_link() const { return leg_right_6_link_a; }
    const Force& getForce_leg_right_6_link() const { return leg_right_6_link_f; }
    ///@}
protected:
...
private:
    ...
    const InertiaMatrix& leg_left_1_link_I;
    Velocity      leg_left_1_link_v;
    Acceleration  leg_left_1_link_a;
    Force         leg_left_1_link_f;
    // Link 'leg_left_2_link' :
    const InertiaMatrix& leg_left_2_link_I;
    Velocity      leg_left_2_link_v;
    Acceleration  leg_left_2_link_a;
    Force         leg_left_2_link_f;
    // Link 'leg_left_3_link' :
    const InertiaMatrix& leg_left_3_link_I;
    Velocity      leg_left_3_link_v;
    Acceleration  leg_left_3_link_a;
    Force         leg_left_3_link_f;
    // Link 'leg_left_4_link' :
    const InertiaMatrix& leg_left_4_link_I;
    Velocity      leg_left_4_link_v;
    Acceleration  leg_left_4_link_a;
    Force         leg_left_4_link_f;
    // Link 'leg_left_5_link' :
    const InertiaMatrix& leg_left_5_link_I;
    Velocity      leg_left_5_link_v;
    Acceleration  leg_left_5_link_a;
    Force         leg_left_5_link_f;
    // Link 'leg_left_6_link' :
    const InertiaMatrix& leg_left_6_link_I;
    Velocity      leg_left_6_link_v;
    Acceleration  leg_left_6_link_a;
    Force         leg_left_6_link_f;
    // Link 'leg_right_1_link' :
    const InertiaMatrix& leg_right_1_link_I;
    Velocity      leg_right_1_link_v;
    Acceleration  leg_right_1_link_a;
    Force         leg_right_1_link_f;
    // Link 'leg_right_2_link' :
    const InertiaMatrix& leg_right_2_link_I;
    Velocity      leg_right_2_link_v;
    Acceleration  leg_right_2_link_a;
    Force         leg_right_2_link_f;
    // Link 'leg_right_3_link' :
    const InertiaMatrix& leg_right_3_link_I;
    Velocity      leg_right_3_link_v;
    Acceleration  leg_right_3_link_a;
    Force         leg_right_3_link_f;
    // Link 'leg_right_4_link' :
    const InertiaMatrix& leg_right_4_link_I;
    Velocity      leg_right_4_link_v;
    Acceleration  leg_right_4_link_a;
    Force         leg_right_4_link_f;
    // Link 'leg_right_5_link' :
    const InertiaMatrix& leg_right_5_link_I;
    Velocity      leg_right_5_link_v;
    Acceleration  leg_right_5_link_a;
    Force         leg_right_5_link_f;
    // Link 'leg_right_6_link' :
    const InertiaMatrix& leg_right_6_link_I;
    Velocity      leg_right_6_link_v;
    Acceleration  leg_right_6_link_a;
    Force         leg_right_6_link_f;
    ...
    InertiaMatrix leg_left_1_link_Ic;
    InertiaMatrix leg_left_2_link_Ic;
    InertiaMatrix leg_left_3_link_Ic;
    InertiaMatrix leg_left_4_link_Ic;
    InertiaMatrix leg_left_5_link_Ic;
    const InertiaMatrix& leg_left_6_link_Ic;
    InertiaMatrix leg_right_1_link_Ic;
    InertiaMatrix leg_right_2_link_Ic;
    InertiaMatrix leg_right_3_link_Ic;
    InertiaMatrix leg_right_4_link_Ic;
    InertiaMatrix leg_right_5_link_Ic;
    const InertiaMatrix& leg_right_6_link_Ic;
...
{
    (xm->fr_leg_left_1_link_X_fr_base_link)(q);
    (xm->fr_leg_left_2_link_X_fr_leg_left_1_link)(q);
    (xm->fr_leg_left_3_link_X_fr_leg_left_2_link)(q);
    (xm->fr_leg_left_4_link_X_fr_leg_left_3_link)(q);
    (xm->fr_leg_left_5_link_X_fr_leg_left_4_link)(q);
    (xm->fr_leg_left_6_link_X_fr_leg_left_5_link)(q);
    (xm->fr_leg_right_1_link_X_fr_base_link)(q);
    (xm->fr_leg_right_2_link_X_fr_leg_right_1_link)(q);
    (xm->fr_leg_right_3_link_X_fr_leg_right_2_link)(q);
    (xm->fr_leg_right_4_link_X_fr_leg_right_3_link)(q);
    (xm->fr_leg_right_5_link_X_fr_leg_right_4_link)(q);
    (xm->fr_leg_right_6_link_X_fr_leg_right_5_link)(q);
}
