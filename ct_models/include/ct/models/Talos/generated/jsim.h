#ifndef IIT_TALOS_JSIM_H_
#define IIT_TALOS_JSIM_H_
...
/**
 * The type of the Joint Space Inertia Matrix (JSIM) of the robot Talos.
 */
template <typename TRAIT>
class JSIM : public iit::rbd::StateDependentMatrix<iit::Talos::tpl::JointState<typename TRAIT::Scalar>, 18, 18, JSIM<TRAIT>>
{
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW
    private:
        typedef iit::rbd::StateDependentMatrix<iit::Talos::tpl::JointState<typename TRAIT::Scalar>, 18, 18, JSIM<TRAIT>> Base;
    public:
        ...
        typedef iit::Talos::tpl::ForceTransforms<TRAIT> FTransforms;
