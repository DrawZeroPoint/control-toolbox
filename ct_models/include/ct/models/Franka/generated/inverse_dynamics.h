#ifndef IIT_FRANKA_INVERSE_DYNAMICS_H_
#define IIT_FRANKA_INVERSE_DYNAMICS_H_
...
/**
 * The Inverse Dynamics routine for the robot Franka.
 *
...
public:
    ...
    typedef iit::Franka::tpl::JointState<Scalar> JointState;
...
public:
     ...
     */
    ///@{
    const Velocity& getVelocity_panda_link1() const { return panda_link1_v; }
    const Acceleration& getAcceleration_panda_link1() const { return panda_link1_a; }
    const Force& getForce_panda_link1() const { return panda_link1_f; }
    const Velocity& getVelocity_panda_link2() const { return panda_link2_v; }
    const Acceleration& getAcceleration_panda_link2() const { return panda_link2_a; }
    const Force& getForce_panda_link2() const { return panda_link2_f; }
    const Velocity& getVelocity_panda_link3() const { return panda_link3_v; }
    const Acceleration& getAcceleration_panda_link3() const { return panda_link3_a; }
    const Force& getForce_panda_link3() const { return panda_link3_f; }
    const Velocity& getVelocity_panda_link4() const { return panda_link4_v; }
    const Acceleration& getAcceleration_panda_link4() const { return panda_link4_a; }
    const Force& getForce_panda_link4() const { return panda_link4_f; }
    const Velocity& getVelocity_panda_link5() const { return panda_link5_v; }
    const Acceleration& getAcceleration_panda_link5() const { return panda_link5_a; }
    const Force& getForce_panda_link5() const { return panda_link5_f; }
    const Velocity& getVelocity_panda_link6() const { return panda_link6_v; }
    const Acceleration& getAcceleration_panda_link6() const { return panda_link6_a; }
    const Force& getForce_panda_link6() const { return panda_link6_f; }
    const Velocity& getVelocity_panda_link7() const { return panda_link7_v; }
    const Acceleration& getAcceleration_panda_link7() const { return panda_link7_a; }
    const Force& getForce_panda_link7() const { return panda_link7_f; }
    ///@}
protected:
...
private:
    ...
    // Link 'panda_link1' :
    const InertiaMatrix& panda_link1_I;
    Velocity      panda_link1_v;
    Acceleration  panda_link1_a;
    Force         panda_link1_f;
    // Link 'panda_link2' :
    const InertiaMatrix& panda_link2_I;
    Velocity      panda_link2_v;
    Acceleration  panda_link2_a;
    Force         panda_link2_f;
    // Link 'panda_link3' :
    const InertiaMatrix& panda_link3_I;
    Velocity      panda_link3_v;
    Acceleration  panda_link3_a;
    Force         panda_link3_f;
    // Link 'panda_link4' :
    const InertiaMatrix& panda_link4_I;
    Velocity      panda_link4_v;
    Acceleration  panda_link4_a;
    Force         panda_link4_f;
    // Link 'panda_link5' :
    const InertiaMatrix& panda_link5_I;
    Velocity      panda_link5_v;
    Acceleration  panda_link5_a;
    Force         panda_link5_f;
    // Link 'panda_link6' :
    const InertiaMatrix& panda_link6_I;
    Velocity      panda_link6_v;
    Acceleration  panda_link6_a;
    Force         panda_link6_f;
    // Link 'panda_link7' :
    const InertiaMatrix& panda_link7_I;
    Velocity      panda_link7_v;
    Acceleration  panda_link7_a;
    Force         panda_link7_f;
...
{
    (xm->fr_panda_link1_X_fr_table)(q);
    (xm->fr_panda_link2_X_fr_panda_link1)(q);
    (xm->fr_panda_link3_X_fr_panda_link2)(q);
    (xm->fr_panda_link4_X_fr_panda_link3)(q);
    (xm->fr_panda_link5_X_fr_panda_link4)(q);
    (xm->fr_panda_link6_X_fr_panda_link5)(q);
    (xm->fr_panda_link7_X_fr_panda_link6)(q);
}
